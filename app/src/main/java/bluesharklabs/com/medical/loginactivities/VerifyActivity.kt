...
import kotlinx.android.synthetic.main.activity_verify.progressBar
import kotlinx.android.synthetic.main.activity_verify.text_register
...
*/
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            R.id.text_resend -> {
                AppConstant.hideSoftKeyBoard(this@VerifyActivity,v)
