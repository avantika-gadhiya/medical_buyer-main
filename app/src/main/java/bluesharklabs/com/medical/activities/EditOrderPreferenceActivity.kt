...
class EditOrderPreferenceActivity : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_edit_order_preference)
        ...
        val drugPreferences = arrayOf("Only Prescription Brand")
        val spinner = findViewById<Spinner>(R.id.spinner_store_pickup)
        val spinner1 = findViewById<Spinner>(R.id.spinner_drug_prefrnc)

        edt_from_date.setFocusable(false)
        edt_from_date.setClickable(true)

        edt_from_time.setFocusable(false)
        edt_from_time.setClickable(true)

        edt_to_time.setFocusable(false)
        edt_to_time.setClickable(true)

        //edt_delivery_date1.setFocusable(false)
       // edt_delivery_date1.setClickable(true)

        //edt_from_time1.setFocusable(false)
        //edt_from_time1.setClickable(true)

        edt_to_time1.setFocusable(false)
        edt_to_time1.setClickable(true)
       ...
       // edt_delivery_date1.setOnClickListener(this)
       // edt_from_time1.setOnClickListener(this)
        edt_to_time1.setOnClickListener(this)
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btn_save_n_continue -> {
                Log.e("HELLOMAPS","EDITOrderPref")
                startActivity(
                    Intent(
                        this@EditOrderPreferenceActivity,
                        FinalOrderActivity::class.java
                    )
                )
                //finish()
                overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left)
            }
            R.id.edt_delivery_date -> {
                flag = false
                showCalender()
            }
            R.id.edt_from_time -> {
...
//                    bitmap = BitmapFactory.decodeFile(path)
    ...
    private fun showCalender() {
        ...
        val datePickerDialog = DatePickerDialog(
            this@EditOrderPreferenceActivity, this,
    ...
    private fun updateLabel1() {
        ...
        //edt_delivery_date1?.setText(from_date1)
    }
    ...
    private fun timepicker2() {
        ...
        val timeSetListener = TimePickerDialog.OnTimeSetListener { timePicker, hour, minute ->
            ...
            //edt_from_time1!!.setText(SimpleDateFormat("hh:mm a").format(cal.time))
